// app/interview-prep/page.js
"use client";

import Link from "next/link";
import { motion } from "framer-motion";
import { Mic, FileText, Code2, Sparkles, ArrowRight, Lock, Clock } from "lucide-react";
    ...
    <main className="min-h-screen bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="text-center mb-20">
          ...
          >
             <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-neutral-200 to-neutral-500 tracking-tight">
...
// ==========================================
// FEATURE CARD (With Large Top-Right Badge)
// ==========================================
  ...
  return (
    <Link href={href} className="block group h-full relative">
      ...
      >
        ...
        <div 
          className={`
            absolute -inset-0.5 bg-gradient-to-b ${gradient} 
          ...
          <div className="relative h-full flex flex-col rounded-[23px] overflow-hidden bg-neutral-950">
            ...
            <div className="relative z-10 p-6 sm:p-8 flex flex-col h-full">
                  ...
                  <div className="absolute top-5 right-5 z-20">
                    <div className="relative group/badge">
                      ...
                      ">
                        ...
                        <Sparkles className="w-4 h-4 text-yellow-950 fill-yellow-950 animate-[spin_3s_linear_infinite]" />
                        <span className="text-xs font-black uppercase tracking-widest text-yellow-950 drop-shadow-sm">
                          New Arrival
                        </span>
                      </div>
                    </div>
              ...
              <div className="flex-grow space-y-4 mb-8">
                <h3 className="text-3xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-indigo-200 to-sky-200 group-hover:via-white group-hover:to-white transition-all duration-300">
                  {title}
                </h3>
                
                <p className="text-slate-400 font-medium text-base leading-relaxed group-hover:text-slate-300 transition-colors">
                  {description}
                </p>
              </div>
              ...
              <div className="mt-auto relative z-20">
                ...
                ">
                  ...
                  <div className="relative flex items-center justify-between px-6 py-4">
                    <span className="font-extrabold tracking-widest text-sm text-white group-hover:drop-shadow-[0_2px_2px_rgba(0,0,0,0.3)] transition-all">
                      START PRACTICE
                    </span>
                    <div className="
...
// ==========================================
// COMING SOON CARD (With Large Top-Right Badge)
// ==========================================
    ...
    >
      ...
      <div className="relative h-full bg-gray-950/40 backdrop-blur-sm rounded-[23px] p-6 sm:p-8 border border-white/5 border-dashed flex flex-col justify-between">
        ...
        <div className="relative">
          {/* Header */}
          <div className="flex justify-between items-start mb-8">
            <div className="p-4 rounded-2xl bg-gray-800/50 ring-1 ring-white/10">
              <Code2 className="w-6 h-6 text-gray-500" />
            </div>
            
            {/* --- COMING SOON BADGE (Large, Top Right) --- */}
            <div className="absolute top-0 right-0">
               <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-neutral-800 border border-neutral-700 shadow-lg">
          ...
          <h3 className="text-2xl font-bold text-gray-500 mb-3">Coding Challenges</h3>
        ...
        <div className="mt-8">
           <span className="inline-flex items-center px-4 py-2 rounded-full bg-gray-800/50 text-gray-500 text-xs font-bold border border-gray-700/50 uppercase tracking-widest">
