...
import { getSession, generateSessionAnalysis } from '@/actions/mockInterview';
    ...
    return (
        <div className="min-h-screen bg-[#020202] text-slate-200 pb-20 selection:bg-indigo-500/30">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 py-12 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                {/* 7. FOOTER ACTIONS */}
                <footer className="flex flex-col sm:flex-row justify-center items-center gap-4 py-8 border-t border-white/5">
                    <button onClick={() => router.push('/ai-career-prep/ai-mock-interview')} className="px-6 py-3 text-slate-500 hover:text-white text-xs font-bold uppercase tracking-widest transition-all flex items-center gap-2">
                        <LayoutDashboard size={14} /> Dashboard
                    </button>
                    <button onClick={() => router.push('/ai-career-prep/ai-mock-interview/setup')} className="bg-white hover:bg-slate-200 text-black px-8 py-3 rounded-xl font-bold text-xs uppercase tracking-widest transition-all shadow-lg flex items-center gap-2 active:scale-95">
